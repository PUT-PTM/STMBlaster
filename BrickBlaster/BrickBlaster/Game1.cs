    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        void Grafika_Ca³a()
        {
            ...
            for (int l = 0; l < 11; l++)
            {
                ...
                for (int i = 0; i < 13; i++)
                {
                    Sprawdzanie_pol_tabeli(i, l);
                }
                Zamiana = ZamianaUstaw();
                //------------------------------------------------------------------------------------------Grafika poruszania siê cd. : ----------------------------------------------------------------------------------------------
                //--------------------------------------------------------------------------------------------------------------------Grafika poruszania siê : Gracz1 ------------------------------------------------------------
                    Grafika_Poruszanie2(Gracz1, Klawiatura1.Zwracanie(),Zamiana); 
                //--------------------------------------------------------------------------------------------------------------------Grafika poruszania siê : Gracz2 ------------------------------------------------------------                            
        ...
        void Grafika_Interface()
        {
            ...
            for (int i = 1; i < Gracz1.Max_Bomb; i++)
            {
                if (i < 4)
            ...
            for (int i = 1; i < Gracz2.Max_Bomb; i++)
            {
                if (i < 4)
        ...
        void Sprawdzanie_pol_tabeli(int i, int l)
        {
            if (Mapa1.tab_mapa[i, l] == 1)
            {
                spriteBatch.Draw(Unbreakable, new Vector2(275 + (i * 50), 62 + (l * 50)), Color.White);
            }
            if (Mapa1.tab_mapa[i, l] == 2)
            {
                spriteBatch.Draw(Breakable, new Vector2(275 + (i * 50), 62 + (l * 50)), Color.White);
            }
            if (Mapa1.tab_mapa[i, l] == 20000)
            {
                spriteBatch.Draw(Ogien_koniec_E, new Vector2(275 + (i * 50), 66 + (l * 50)), Color.White);
                if (licznik_klatek % 55 == 0)
                    Mapa1.tab_mapa[i, l] = Mapa1.tab_mapa[i, l] - 20000;
            }
            if (Mapa1.tab_mapa[i, l] == 21000)
            {

                spriteBatch.Draw(Ogien_koniec_W, new Vector2(275 + (i * 50), 66 + (l * 50)), Color.White);
                if (licznik_klatek % 55 == 0)
                    Mapa1.tab_mapa[i, l] = Mapa1.tab_mapa[i, l] - 21000;
            }
            if (Mapa1.tab_mapa[i, l] == 22000)
            {

                spriteBatch.Draw(Ogien_koniec_S, new Vector2(275 + (i * 50), 66 + (l * 50)), Color.White);
                if (licznik_klatek % 55 == 0)
                    Mapa1.tab_mapa[i, l] = Mapa1.tab_mapa[i, l] - 22000;
            }
            if (Mapa1.tab_mapa[i, l] == 23000)
            {

                spriteBatch.Draw(Ogien_koniec_N, new Vector2(275 + (i * 50), 66 + (l * 50)), Color.White);
                if (licznik_klatek % 55 == 0)
                    Mapa1.tab_mapa[i, l] = Mapa1.tab_mapa[i, l] - 23000;
            }
            if (Mapa1.tab_mapa[i, l] == 20400)
            {
                spriteBatch.Draw(Ogien_koniec_E, new Vector2(275 + (i * 50), 66 + (l * 50)), Color.White);
                if (licznik_klatek % 55 == 0)
                    Mapa1.tab_mapa[i, l] = Mapa1.tab_mapa[i, l] - 20000;
            }
            if (Mapa1.tab_mapa[i, l] == 20401)
            {
                spriteBatch.Draw(Ogien_koniec_E, new Vector2(275 + (i * 50), 66 + (l * 50)), Color.White);
                if (licznik_klatek % 55 == 0)
                    Mapa1.tab_mapa[i, l] = Mapa1.tab_mapa[i, l] - 20000;
            }
            if (Mapa1.tab_mapa[i, l] == 20402)
            {
                spriteBatch.Draw(Ogien_koniec_E, new Vector2(275 + (i * 50), 66 + (l * 50)), Color.White);
                if (licznik_klatek % 55 == 0)
                    Mapa1.tab_mapa[i, l] = Mapa1.tab_mapa[i, l] - 20000;
            }
            if (Mapa1.tab_mapa[i, l] == 20403)
            {
                spriteBatch.Draw(Ogien_koniec_E, new Vector2(275 + (i * 50), 66 + (l * 50)), Color.White);
                if (licznik_klatek % 55 == 0)
                    Mapa1.tab_mapa[i, l] = Mapa1.tab_mapa[i, l] - 20000;
            }
            if (Mapa1.tab_mapa[i, l] == 21400)
            {
                spriteBatch.Draw(Ogien_koniec_W, new Vector2(275 + (i * 50), 66 + (l * 50)), Color.White);
                if (licznik_klatek % 55 == 0)
                    Mapa1.tab_mapa[i, l] = Mapa1.tab_mapa[i, l] - 21000;
            }
            if (Mapa1.tab_mapa[i, l] == 21401)
            {
            ...
            if (Mapa1.tab_mapa[i, l] == 21402)
            {
                spriteBatch.Draw(Ogien_koniec_W, new Vector2(275 + (i * 50), 66 + (l * 50)), Color.White);
                if (licznik_klatek % 55 == 0)
                    Mapa1.tab_mapa[i, l] = Mapa1.tab_mapa[i, l] - 21000;
            }
            if (Mapa1.tab_mapa[i, l] == 21403)
            {
                spriteBatch.Draw(Ogien_koniec_W, new Vector2(275 + (i * 50), 66 + (l * 50)), Color.White);
                if (licznik_klatek % 55 == 0)
                    Mapa1.tab_mapa[i, l] = Mapa1.tab_mapa[i, l] - 21000;
            }
            if (Mapa1.tab_mapa[i, l] == 22400)
            {
                spriteBatch.Draw(Ogien_koniec_S, new Vector2(275 + (i * 50), 66 + (l * 50)), Color.White);
                if (licznik_klatek % 55 == 0)
                    Mapa1.tab_mapa[i, l] = Mapa1.tab_mapa[i, l] - 22000;
            }
            if (Mapa1.tab_mapa[i, l] == 22401)
            {
                spriteBatch.Draw(Ogien_koniec_S, new Vector2(275 + (i * 50), 66 + (l * 50)), Color.White);
                if (licznik_klatek % 55 == 0)
                    Mapa1.tab_mapa[i, l] = Mapa1.tab_mapa[i, l] - 22000;
            }
            if (Mapa1.tab_mapa[i, l] == 22402)
            {
                spriteBatch.Draw(Ogien_koniec_S, new Vector2(275 + (i * 50), 66 + (l * 50)), Color.White);
                if (licznik_klatek % 55 == 0)
                    Mapa1.tab_mapa[i, l] = Mapa1.tab_mapa[i, l] - 22000;
            }
            if (Mapa1.tab_mapa[i, l] == 22403)
            {
                spriteBatch.Draw(Ogien_koniec_S, new Vector2(275 + (i * 50), 66 + (l * 50)), Color.White);
                if (licznik_klatek % 55 == 0)
                    Mapa1.tab_mapa[i, l] = Mapa1.tab_mapa[i, l] - 22000;
            }
            if (Mapa1.tab_mapa[i, l] == 23400)
            {
                spriteBatch.Draw(Ogien_koniec_N, new Vector2(275 + (i * 50), 66 + (l * 50)), Color.White);
                if (licznik_klatek % 55 == 0)
                    Mapa1.tab_mapa[i, l] = Mapa1.tab_mapa[i, l] - 23000;
            }
            if (Mapa1.tab_mapa[i, l] == 23401)
            {
                spriteBatch.Draw(Ogien_koniec_N, new Vector2(275 + (i * 50), 66 + (l * 50)), Color.White);
                if (licznik_klatek % 55 == 0)
                    Mapa1.tab_mapa[i, l] = Mapa1.tab_mapa[i, l] - 23000;
            }
            if (Mapa1.tab_mapa[i, l] == 23402)
            {
                spriteBatch.Draw(Ogien_koniec_N, new Vector2(275 + (i * 50), 66 + (l * 50)), Color.White);
                if (licznik_klatek % 55 == 0)
                    Mapa1.tab_mapa[i, l] = Mapa1.tab_mapa[i, l] - 23000;
            }
            if (Mapa1.tab_mapa[i, l] == 23403)
            {
                spriteBatch.Draw(Ogien_koniec_N, new Vector2(275 + (i * 50), 66 + (l * 50)), Color.White);
                if (licznik_klatek % 55 == 0)
                    Mapa1.tab_mapa[i, l] = Mapa1.tab_mapa[i, l] - 23000;
            }
            if (Mapa1.tab_mapa[i, l] == 30000)
            {
                spriteBatch.Draw(Ogien_srodek, new Vector2(275 + (i * 50), 66 + (l * 50)), Color.White);
                if (licznik_klatek % 55 == 0)
                    Mapa1.tab_mapa[i, l] = Mapa1.tab_mapa[i, l] - 30000;
            }
            if (Mapa1.tab_mapa[i, l] == 40000)
            {

                spriteBatch.Draw(Ogien_poziom, new Vector2(275 + (i * 50), 66 + (l * 50)), Color.White);
                if (licznik_klatek % 55 == 0)
                    Mapa1.tab_mapa[i, l] = Mapa1.tab_mapa[i, l] - 40000;
            }
            if (Mapa1.tab_mapa[i, l] == 41000)
            {

                spriteBatch.Draw(Ogien_pion, new Vector2(275 + (i * 50), 66 + (l * 50)), Color.White);
                if (licznik_klatek % 55 == 0)
                    Mapa1.tab_mapa[i, l] = Mapa1.tab_mapa[i, l] - 41000;
            }
            if (Mapa1.tab_mapa[i, l] == 400)
            {
                spriteBatch.Draw(Bonus_Max, new Vector2(275 + (i * 50), 66 + (l * 50)), Color.White);
            }
            if (Mapa1.tab_mapa[i, l] == 401)
            {
                spriteBatch.Draw(Bonus_Moc, new Vector2(275 + (i * 50), 66 + (l * 50)), Color.White);
            }
            if (Mapa1.tab_mapa[i, l] == 402)
            {
                spriteBatch.Draw(Kara, new Vector2(275 + (i * 50), 66 + (l * 50)), Color.White);
            }
            if (Mapa1.tab_mapa[i, l] == 403)
            {
                spriteBatch.Draw(Kara, new Vector2(275 + (i * 50), 66 + (l * 50)), Color.White);
            }
            if (Mapa1.tab_mapa[i, l] >= Gracz1.Id_bomb && Mapa1.tab_mapa[i, l] < (Gracz1.Id_bomb + 10))
            {
                if (zamiana == 0 || zamiana == 2)
                {
            ...
            if (Mapa1.tab_mapa[i, l] >= Gracz2.Id_bomb && Mapa1.tab_mapa[i, l] < (Gracz2.Id_bomb + 10))
            {
                if (zamiana == 0 || zamiana == 2)
                {
                    spriteBatch.Draw(Bomba, new Vector2(275 + (i * 50), 66 + (l * 50)), Color.White);
